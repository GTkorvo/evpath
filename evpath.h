 ...
 * 
 * This function will be called by EVdrain_stone. It will form a contiguous data
 * structure containing the encoded versions of the events associated with the stone
 * and its actions. The data structure returned will be a variable sized array 
 * containing the sizes of the events followed by the encoded events themselves.
 * It is of the form size1-event1-size2-event2....-sizen-eventn.
 * \param cm The CManager in which the stone is registered
 * \param stone The stone whose associated events are to be extracted
 * \return char* Returns a variable sized array
 */
extern char*
