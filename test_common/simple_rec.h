/*
 * Common test record definitions used across EVPath test suites.
 * This file consolidates the simple_rec structure and FFS format
 * definitions that were previously duplicated in many test files.
 */
#ifndef EVPATH_TEST_SIMPLE_REC_H
#define EVPATH_TEST_SIMPLE_REC_H
...
#endif /* EVPATH_TEST_SIMPLE_REC_H */
