...
void
join_handler_func(EVdfg_master master, char *identifier, void*cur_unused1, void*cur_unused2)
{
	...
	EVdfg_assign_canonical_name(master, identifier, "b");
	i++;
	...
	EVdfg_assign_canonical_name(master, identifier, "c");
...
int main(int argc, char **argv)
{
    ...
    EVdfg_node_join_handler (test_master, join_handler_func);
