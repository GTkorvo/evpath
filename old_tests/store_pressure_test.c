...
static IOField control_field_list[] =
{
    {"command", "integer",
     sizeof(int), IOOffset(control_rec_ptr, command)}, 
    {"argument", "integer",
     sizeof(int), IOOffset(control_rec_ptr, argument)},
    {NULL, NULL, 0, 0}
};

static CMFormatRec control_format_list[] =
{
...
static int filter_accept(CManager cm, void *msg, void *client_data, attr_list attrs) {
    (void)cm; (void)msg; (void)client_data; (void)attrs;
    return 1;
}
static int filter_reject(CManager cm, void *msg, void *client_data, attr_list attrs) {
    (void)cm; (void)msg; (void)client_data; (void)attrs;
    return 0;
}
